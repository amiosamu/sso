...
import (
	...
	"github.com/amiosamu/sso/internal/domain/models"
	"github.com/amiosamu/sso/internal/lib/jwt"
	"github.com/amiosamu/sso/internal/lib/logger/sl"
	"github.com/amiosamu/sso/internal/storage"
...
func New(log *slog.Logger, usrSaver UserSaver, usrProvider UserProvider, appProvider AppProvider, tokenTLL time.Duration) *Auth {
	return &Auth{
		log:         log,
		usrSaver:    usrSaver,
